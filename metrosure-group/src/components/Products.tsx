...
const products = [
  ...
  },
  {
    ...
    description:
      "Ensure your loved ones are looked after. From individual life policies to group funeral cover, we've got your family covered.",
    features: ["Life Insurance", "Funeral Plans", "Will Drafting"],
    href: "/insurance/life",
  },
  {
    icon: "savings",
