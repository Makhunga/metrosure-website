...
export const metadata: Metadata = {
  title: "Life & Funeral Cover | Metrosure Group",
  description:
    "Protect your family's future with life insurance, funeral cover, and retirement planning from Metrosure. We help South African families feel secure.",
  openGraph: {
    title: "Life & Funeral Cover | Metrosure Group",
    description:
      "Protect your family's future with life insurance and funeral cover from Metrosure.",
    type: "website",
  },
};
...
const coverageFeatures = [
  ...
  },
  {
    ...
    title: "Will Drafting",
    description:
      "Protect your legacy with a professionally drafted will. Make sure your assets go to the people you choose, not the state.",
  },
  {
  ...
  },
  {
    ...
    description:
      "A tax-free lump sum if you're diagnosed with a serious illness like cancer, stroke, or heart attack. Use it however you need.",
  },
];
