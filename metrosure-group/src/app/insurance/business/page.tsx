...
export const metadata: Metadata = {
  title: "Business & Employee Benefits | Metrosure Group",
  description:
    "Commercial insurance and employee benefits from Metrosure. Protect your business, your assets, and your team with comprehensive cover.",
  openGraph: {
    title: "Business & Employee Benefits | Metrosure Group",
    description:
      "Commercial insurance and employee benefits from Metrosure. Protect your business and team.",
    type: "website",
  },
};
