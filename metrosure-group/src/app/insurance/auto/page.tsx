...
export const metadata: Metadata = {
  title: "Car & Home Insurance | Metrosure Group",
  description:
    "Protect your vehicle and home with comprehensive short-term insurance from Metrosure. We work with SA's top insurers to find you the right cover.",
  openGraph: {
    title: "Car & Home Insurance | Metrosure Group",
    description:
      "Protect your vehicle and home with comprehensive short-term insurance from Metrosure.",
    type: "website",
  },
};
