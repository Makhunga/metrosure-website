      ...
      <section ref={timelineRef} className="py-24 md:py-32 bg-[rgb(var(--color-surface))]">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <motion.div
              className="absolute left-[40px] top-4 bottom-4 w-0.5 bg-[rgb(var(--color-border-light))]"
            ...
            <div className="flex flex-col space-y-20">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div
                    className={`p-8 md:p-10 rounded-3xl border shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden group-hover:-translate-y-1 ${
                      item.isSpecial
      ...
      <section ref={teamRef} className="py-24 md:py-32 px-6 lg:px-12 max-w-7xl mx-auto relative overflow-hidden">
        ...
        >
          {team.map((member, index) => (
            <motion.div
              key={index}
              className={`group h-[500px] relative w-full rounded-2xl transition-all duration-500 hover:z-20 ${
                index === 1 ? "lg:mt-12" : ""
              }`}
              variants={itemVariants}
            ...
            >
              <div className="relative w-full h-full shadow-xl hover:shadow-2xl hover:shadow-primary/20 rounded-2xl overflow-hidden bg-[rgb(var(--color-surface-card))] border border-[rgb(var(--color-border-light))]">
                {/* Front State */}
