...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Join our outbound sales team and help South Africans protect what matters most. Make outbound calls to potential clients, present insurance solutions, and close sales.",
    metaDescription:
      "Call Centre Agent position at Metrosure in KwaZulu-Natal. Outbound insurance sales role with competitive rates and career advancement. Apply today.",
    responsibilities: [
      "Make outbound calls to potential clients and present insurance products",
      "Achieve daily, weekly, and monthly sales targets",
      "Follow up on leads and convert them into sales",
      "Maintain accurate records of all customer interactions and sales",
    ],
    requirements: [
      "Matric certificate (Grade 12)",
      "Minimum 1 year call centre experience",
      "Minimum 1 year insurance industry experience",
      "Excellent verbal communication and persuasion skills",
      "Basic computer literacy",
      "Target-driven with a strong sales mindset",
    ],
    offers: [
