      ...
      >
        <div className="w-full max-w-md mx-auto">
          ...
          <motion.div
            ...
            className="mb-6 p-4 rounded-xl bg-amber-50 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-800"
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-700 dark:text-amber-300 text-xs mt-1">
                  This is a portal mockup. Any credentials will grant access to the demo.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <motion.button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-[rgb(var(--color-border-light))] bg-[rgb(var(--color-surface))] hover:border-primary/50 hover:shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          >
            ...
            <motion.button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-lg bg-primary text-white font-bold hover:bg-[rgb(var(--color-primary-hover))] shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
