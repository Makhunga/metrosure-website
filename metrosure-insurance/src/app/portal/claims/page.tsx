    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                  ...
                  <button
                    ...
                    className={`text-left p-4 rounded-xl border transition-all ${
                      selectedClaim.id === claim.id
                        ...
                        : 'bg-[var(--surface-card)] border-[var(--border-light)] hover:border-[var(--border-medium)]'
                    }`}
                  >
        ...
        {selectedClaim && (
          ...
          >
            <div className="sticky top-24 bg-[var(--surface-card)] rounded-2xl border border-[var(--border-light)] p-6 shadow-lg">
