      ...
      <motion.div variants={itemVariants} className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl border border-[var(--border-light)] bg-[var(--surface-card)] text-[var(--text-main)] placeholder:text-[var(--text-subtle)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)]"
          />
          {searchQuery && (
            <button
          ...
          <div className="hidden sm:flex items-center gap-1 p-1 rounded-xl bg-[var(--surface-inset)] border border-[var(--border-light)]">
            <button
              ...
              className={`p-2 rounded-lg transition-all ${
                viewMode === 'grid'
                  ? 'bg-[var(--surface-card)] shadow-sm text-[var(--primary)]'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredDocuments.map((doc, index) => (
                <motion.div
                  ...
                  className="group p-5 rounded-2xl bg-[var(--surface-card)] border border-[var(--border-light)] hover:border-[var(--primary)]/30 hover:shadow-lg transition-all cursor-pointer"
                >
              ...
              <div className="divide-y divide-[var(--border-light)]">
                {filteredDocuments.map((doc, index) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-4 hover:bg-[var(--surface-inset)] transition-colors cursor-pointer group"
                  >
