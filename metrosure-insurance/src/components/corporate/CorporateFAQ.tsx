...
import { corporateFAQs } from "@/data/corporateServices";
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Everything you need to know about corporate employee benefits.
        ...
        <div className="max-w-6xl mx-auto columns-1 lg:columns-2 gap-4 space-y-4">
          {corporateFAQs.map((item, index) => (
            <div key={index} className="break-inside-avoid">
              <FAQItem {...item} index={index} isInView={isInView} />
            </div>
          ))}
        </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:clients@metrosureconsult.co.za"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-[rgb(var(--color-border-light))] rounded-xl text-[rgb(var(--color-text-main))] font-medium hover:border-primary hover:text-primary transition-colors"
            >
              <span className="material-symbols-outlined text-xl">mail</span>
              <span>clients@metrosureconsult.co.za</span>
            </a>
          </div>
        </motion.div>
      </div>
