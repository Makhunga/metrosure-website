...
// Professional gradient palette for partner avatars
const partnerGradients = [
  "from-indigo-600 to-blue-500",       // corporate
  "from-emerald-600 to-teal-500",      // growth
  "from-amber-500 to-orange-500",      // energy
  "from-violet-600 to-purple-500",     // innovation
];
...
function getPartnerGradient(index: number): string {
  return partnerGradients[index % partnerGradients.length];
}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-8 pt-6">
                <motion.div
                  className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg ring-2 ring-white/30 dark:ring-white/10 bg-gradient-to-br ${getPartnerGradient(index)}`}
